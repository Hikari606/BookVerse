...
function Home({
  ...
  return (
    <div className="flex flex-col items-center w-full px-4 md:px-0">
      ...
      {/* Welcome animation */}
      <div className="text-center mb-8 space-y-4 animate-float">
        <div className="text-4xl md:text-6xl font-semibold font-serif text-[#0197BC]" >
      ...
      <BookGrid
        books={displayedBooks.filter((book) => [2, 4, 7].includes(book.id))}
        favorites={favorites}
